  ...
  return (
    <main className="project-page">
      ...
      <section className="project-hero">
        <p className="project-kicker" data-depth="0.035">{project.eyebrow}</p>
        <h1 data-depth="0.07">{project.title}</h1>
        <p className="project-summary" data-depth="0.1">{project.summary}</p>
      ...
      <section className="project-story">
        {project.sections.map((section) => (
          <article key={section.number} data-depth="0.03">
      ...
      {slug === "mongolia" && (
        <section className="project-result">
          ...
          <h2 data-depth="0.04">Zuun Baruun Kherem</h2>
          <a data-depth="0.025" href="https://doi.org/10.1007/s41826-025-00113-2" target="_blank" rel="noreferrer">
